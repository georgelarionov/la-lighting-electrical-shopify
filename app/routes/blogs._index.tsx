...
const FALLBACK: Post[] = [
  {img: blog1, cat: 'Design', title: 'Choosing color temperature for a workspace', excerpt: 'How warm or cool light changes focus, comfort, and how a room reads — and where to land for an office, a shop, or a home.', author: 'Guy Hawkins', date: 'Jun 24, 2026', href: '/blogs', read: '6 min'},
  {img: blog2, cat: 'Energy', title: 'LED retrofits that pay for themselves', excerpt: 'Where the savings come from, and how fast a commercial retrofit returns on a schedule you can show on paper.', author: 'Jane Cooper', date: 'Jun 12, 2026', href: '/blogs', read: '5 min'},
  {img: blog3, cat: 'Code', title: 'What Title 24 means for your remodel', excerpt: 'A plain-language look at California’s lighting rules for remodels, and how to stay ahead of inspection.', author: 'Devon Lane', date: 'May 30, 2026', href: '/blogs', read: '7 min'},
  {img: blog4, cat: 'Design', title: 'The three layers every room needs', excerpt: 'Ambient, accent, and detail — how layering light makes a space feel finished instead of merely bright.', author: 'Guy Hawkins', date: 'May 18, 2026', href: '/blogs', read: '4 min'},
  {img: blog5, cat: 'How-to', title: 'Lighting controls, explained simply', excerpt: 'Dimmers, scenes, and sensors without the jargon — what actually earns its place on the wall.', author: 'Jane Cooper', date: 'Apr 29, 2026', href: '/blogs', read: '5 min'},
  {img: blog6, cat: 'Commercial', title: 'Designing light for the open office', excerpt: 'Even, glare-free light that follows the daylight and keeps people comfortable at the desk all day.', author: 'Devon Lane', date: 'Apr 15, 2026', href: '/blogs', read: '6 min'},
];
